...
# type of triangle formed by them (equilateral, isosceles or scalene). Then check if the triangle is right-angled.
...
# Checking if it contains a right angle
...
if side_rs**2 + side_st**2 == side_rt**2:
    angle = 'right-angled'
else:
    angle = 'not right-angled'

print('The type of triangle formed by the 3 points is', triangle, 'triangle and it is', angle)
